...
function printInfo(arrPK){
    ...
    form[0].innerHTML+='<br>'+
    '<input type="button" id="newPKButton" class="buttons" value="Добавить">';
    ...
    for(let i = 0; i < arrPK.length; i++){
        ...
        document.getElementById(edit).style.color = 'forestgreen';
        document.getElementById(remove).style.color = 'red';
        document.getElementById(details).style.fontWeight = '600';
